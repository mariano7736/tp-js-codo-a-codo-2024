const url ='https://raw.githubusercontent.com/mariano7736/tp-js-codo-a-codo-2024/main/trabajo/data/productos.json';
...
document.querySelector('.scroll-left').addEventListener('click', () => {
    document.querySelector('.container').scrollBy({
        left: -270, // Adjust this to the width of your cards plus margin
        behavior: 'smooth'
    });
});
...
class TextoAnimado {
    ...
    iniciarAnimacion() {
        const duracionAnimacion = 100; // Duración de la animación en milisegundos
        let cuenta = 0;
